...
//Project BY : Archit Gandotra, Himanish Mishra, Ayush Bhat, Aryan Sharma   
...
void hotel::add()
{
  ...
  ofstream fout("Record.dat",ios::app); ////ios::app performs output operations at the end of the file.
...
void hotel::modify(int r)
{
  ...
  fstream file("Record.dat",ios::in|ios::out|ios::binary);   //ios::out allows output (write operations) to a stream.
...
void hotel::delete_rec(int r)
{
  ...
  char ch;
  ifstream fin("Record.dat",ios::in);
  ofstream fout("temp.dat",ios::out); // //ios::out allows output (write operations) to a stream.
